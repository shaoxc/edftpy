...
class Test(unittest.TestCase):
    ...
    def gen_sub_ks(self, ions, grid, pplist = None, index = None, atomicd = None, xc_kwargs = {}, ke_kwargs = {}, emb_ke_kwargs = {}, gaussian_options= None, **kwargs):
        ...
        params = {
                'cut_off_energy' : ecut * ENERGY_CONV['Hartree']['eV'],
        ...
        # ks_enginer_a = CastepKS(prefix = 'castep_in_a', subcell = subsys_a, cell_params = cell_params, params = params, exttype = 3,
        ks_enginer_a = CastepKS(prefix = False, subcell = subsys_a, cell_params = cell_params, params = params, exttype = 3,
                base_in_file = 'castep_in.param', mixer = mixer)
        opt_options = {}
